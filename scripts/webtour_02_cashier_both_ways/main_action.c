main_action()
{
	...
	/* Создать массив return_flight_array с данными для формы 2 */
	web_reg_save_param(
		"return_flight_array",
	...
	/* Выбираем случайные параметры из массивов outbound_flight_array и return_flight_array */
	...
	lr_end_transaction("webtour_UC02_покупка_билета_в_одну_сторону", LR_AUTO);
